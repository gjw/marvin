...
module.exports.createHtmlReport = function() {
  ...
  reporterPath = path.join('node_modules', 'marvin-js', 'lib', 'reporter');
  ...
  var jqueryPath = path.join('node_modules', 'marvin-js', 'lib', 'reporter', 'assets', 'jquery', 'jquery-1.9.1.js');
  fs.linkSync(jqueryPath, path.join(resultsDir, 'assets', 'jquery-1.9.1.js'));
...
function icingaMsg(stats) {
  ...
  var serviceMsg = util.format("MARVIN %s - OK: %d, Critical: %d, Warning: %d", status,
