...
module.exports = {
  ...
  goOn: function(selector, type, rootEl) {
    ...
    if (typeof selector == 'string'){
      ...
      elem = rootEl ? rootEl.findElement(this.getLocator(selector, type)) : driver.findElement(this.getLocator(selector, type));
    }
    else {
      elem = selector;
    }
    return driver.actions().mouseMove(elem).perform();
  },
