...
module.exports = {
  ...
  saveScreenshot: function (name) {
    ...
    var filePath = path.join(this.config.resultsDir, this.launchDate, 'screenshots', filename);
  ...
  /*savePerfLog: function (name) {
    var dir = path.join(this.config.resultsDir, session.launchDate, 'perf_logs');
